...
-- Acceptance = share of AI responses whose generation event carried
-- accepted = true, out of those where the flag is present (missing on ~13%
-- of calls; flagged_calls makes the base explicit).
