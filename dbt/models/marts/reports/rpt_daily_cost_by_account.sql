...
-- ai_cost_usd sums only reported costs; ai_cost_usd_estimated imputes the
-- missing ones (tokens x the model's observed cost-per-token).
-- uncosted_interactions shows how many rows were imputed.
